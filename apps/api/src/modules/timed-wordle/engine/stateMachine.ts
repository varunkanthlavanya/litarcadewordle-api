import { GLOBAL_CAP_MS, GRACE_DOCK_MS, GRACE_MS, MAX_TRIES, TRY_BUDGET_MS } from "./constants.js";
import { computeFeedback, computeTileScore, type TileColor } from "./scoring.js";
 ...
 * budget+grace window — callers (scheduler/routes) are responsible for having
...
/** Scheduler-driven: try's base budget has elapsed with no submission — open the grace window. */
...
/** Scheduler-driven: grace window fully elapsed with no submission — mark try SKIPPED and advance. */
...
/** Scheduler-driven: the global 360s clock has expired — force-end immediately,
