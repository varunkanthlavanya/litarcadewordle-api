...
// (5-1)*250 + 500 = 1500ms to fully reveal (each tile's flip plays its whole
// CSS animation, not just the first half — see WordleTile.tsx) — otherwise
// clearing `justSolved` early would jump-cut mid-flip tiles straight to
// their final state instead of letting the animation play out.
const FLOURISH_MS = 1600;
