// Verbatim port of apps/api/src/modules/timed-wordle/engine/scoring.ts
// (TileColor was imported from @litarcadewordle/shared-types there; inlined
// here since that workspace package isn't available in the Deno runtime.)
