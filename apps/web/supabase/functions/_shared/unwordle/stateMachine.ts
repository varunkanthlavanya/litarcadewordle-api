// Verbatim port of apps/api/src/modules/unwordle/engine/stateMachine.ts
import { ROWS_PER_PUZZLE, validateGuess, type FailedTile, type TileColor } from "./validation.ts";
